...
class UsuarioView:
    ...
    def crear_interfaz(self):
        ...
        # En la sección de botones, DESPUÉS de "Cargar Datos"
def crear_interfaz(self):
    # ... (tu código existente)
...
def exportar_excel(self):
    try:
        ...
        if usuarios:
            exportador.exportar_excel("usuarios", usuarios)
        else:
...
def exportar_pdf(self):
    try:
        ...
        if usuarios:
            exportador.exportar_pdf("usuarios", usuarios)
        else:
            self.mostrar_mensaje("Advertencia", "No hay usuarios para exportar", "warning")
    ...
    def guardar_usuario(self):
        ...
        if messagebox.askyesno("Confirmar", f"¿Guardar usuario {username}?"):
            self.controller.guardar_usuario(username, email, password, imagen)
